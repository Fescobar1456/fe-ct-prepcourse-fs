...
function numberOfCharacters(string) {
   ...
   //convierte el objeto a array de pares clave valor   
   let arrayPares = Object.entries(frecuencia); 

   //Ordena el array alfabeticamente por clave
   arrayPares.sort((a, b) => a[0].localeCompare(b[0]));  

   //Crea un nuevo objeto ordenado.
   let resultado = Object.fromEntries(arrayPares); 
